...
extern "C" {
    ...
    pub fn _fmpq_cmp_fmpz(p: *const fmpz, q: *const fmpz, r: *const fmpz) -> ::std::os::raw::c_int;
    pub fn fmpq_cmp_fmpz(x: *const fmpq, y: *const fmpz) -> ::std::os::raw::c_int;
    pub fn _fmpq_cmp_ui(p: *const fmpz, q: *const fmpz, c: mp_limb_t) -> ::std::os::raw::c_int;
    pub fn fmpq_cmp_ui(x: *const fmpq, c: mp_limb_t) -> ::std::os::raw::c_int;
    pub fn _fmpq_cmp_si(
        p: *const fmpz,
        q: *const fmpz,
        c: mp_limb_signed_t,
    ) -> ::std::os::raw::c_int;
    pub fn fmpq_cmp_si(x: *const fmpq, c: mp_limb_signed_t) -> ::std::os::raw::c_int;
    pub fn _fmpq_canonicalise(num: *mut fmpz, den: *mut fmpz);
    pub fn fmpq_canonicalise(res: *mut fmpq);
    pub fn _fmpq_is_canonical(num: *const fmpz, den: *const fmpz) -> ::std::os::raw::c_int;
    ...
    pub fn fmpq_pow_fmpz(a: *mut fmpq, b: *const fmpq, e: *const fmpz) -> ::std::os::raw::c_int;
    pub fn _fmpq_addmul(
        rnum: *mut fmpz,
        rden: *mut fmpz,
        op1num: *const fmpz,
