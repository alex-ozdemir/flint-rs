...
extern "C" {
    ...
    pub fn fq_default_ctx_type(ctx: *mut fq_default_ctx_struct) -> c_int;
    pub fn fq_default_ctx_degree(ctx: *mut fq_default_ctx_struct) -> mp_limb_signed_t;
    pub fn fq_default_ctx_prime(prime: *mut fmpz, ctx: *mut fq_default_ctx_struct);
    pub fn fq_default_ctx_modulus(p: *mut fmpz_mod_poly_struct, ctx: *mut fq_default_ctx_struct);
    pub fn fq_default_ctx_order(f: *mut fmpz, ctx: *mut fq_default_ctx_struct);
    pub fn fq_default_ctx_fprint(
        file: *mut FILE,
        ctx: *mut fq_default_ctx_struct,
    ) -> c_int;
    pub fn fq_default_ctx_print(ctx: *mut fq_default_ctx_struct);
    pub fn fq_default_init(rop: *mut fq_default_struct, ctx: *mut fq_default_ctx_struct);
    pub fn fq_default_init2(rop: *mut fq_default_struct, ctx: *mut fq_default_ctx_struct);
    pub fn fq_default_clear(rop: *mut fq_default_struct, ctx: *mut fq_default_ctx_struct);
    ...
    pub fn fq_default_zero(rop: *mut fq_default_struct, ctx: *mut fq_default_ctx_struct);
    pub fn fq_default_one(rop: *mut fq_default_struct, ctx: *mut fq_default_ctx_struct);
    pub fn fq_default_swap(
        op1: *mut fq_default_struct,
        op2: *mut fq_default_struct,
        ctx: *mut fq_default_ctx_struct,
    );
    pub fn fq_default_gen(rop: *mut fq_default_struct, ctx: *mut fq_default_ctx_struct);
    ...
    pub fn fq_default_print(op: *mut fq_default_struct, ctx: *mut fq_default_ctx_struct);
    pub fn fq_default_fprint_pretty(
        file: *mut FILE,
        op: *mut fq_default_struct,
        ctx: *mut fq_default_ctx_struct,
    ) -> c_int;
    pub fn fq_default_print_pretty(op: *mut fq_default_struct, ctx: *mut fq_default_ctx_struct);
