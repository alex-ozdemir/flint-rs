...
impl Default for __gmp_randstate_struct__bindgen_ty_1 {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
extern "C" {
    ...
    pub fn fmpz_equal_si(f: *const fmpz, g: mp_limb_signed_t) -> ::std::os::raw::c_int;
    pub fn fmpz_equal_ui(f: *const fmpz, g: mp_limb_t) -> ::std::os::raw::c_int;
    pub fn fmpz_cmp(f: *const fmpz, g: *const fmpz) -> ::std::os::raw::c_int;
    pub fn fmpz_cmp_ui(f: *const fmpz, g: mp_limb_t) -> ::std::os::raw::c_int;
    pub fn fmpz_cmp_si(f: *const fmpz, g: mp_limb_signed_t) -> ::std::os::raw::c_int;
    ...
    pub fn fmpz_is_perfect_power(root: *mut fmpz, f: *const fmpz) -> ::std::os::raw::c_int;
    ...
    pub fn fmpz_pow_fmpz(a: *mut fmpz, b: *const fmpz, e: *const fmpz) -> ::std::os::raw::c_int;
    pub fn fmpz_sqrt(f: *mut fmpz, g: *const fmpz);
    pub fn fmpz_sqrtrem(f: *mut fmpz, r: *mut fmpz, g: *const fmpz);
    pub fn fmpz_root(r: *mut fmpz, f: *const fmpz, n: mp_limb_signed_t) -> ::std::os::raw::c_int;
    pub fn fmpz_divisible(f: *const fmpz, g: *const fmpz) -> ::std::os::raw::c_int;
    pub fn fmpz_divisible_ui(f: *const fmpz, g: mp_limb_t) -> ::std::os::raw::c_int;
    pub fn fmpz_divides(q: *mut fmpz, g: *const fmpz, h: *const fmpz) -> ::std::os::raw::c_int;
    ...
    pub fn fmpz_tstbit(f: *const fmpz, i: mp_limb_t) -> ::std::os::raw::c_int;
    ...
    pub fn fmpz_invmod(f: *mut fmpz, g: *const fmpz, h: *const fmpz) -> ::std::os::raw::c_int;
    pub fn fmpz_sqrtmod(b: *mut fmpz, a: *const fmpz, p: *const fmpz) -> ::std::os::raw::c_int;
    ...
    pub fn fmpz_is_strong_probabprime(n: *const fmpz, a: *const fmpz) -> ::std::os::raw::c_int;
