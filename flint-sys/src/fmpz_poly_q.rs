...
extern "C" {
    ...
    pub fn fmpz_poly_q_is_canonical(op: *mut fmpz_poly_q_struct) -> c_int;
    ...
    pub fn fmpz_poly_q_set(rop: *mut fmpz_poly_q_struct, op: *mut fmpz_poly_q_struct);
    ...
    pub fn fmpz_poly_q_neg(rop: *mut fmpz_poly_q_struct, op: *mut fmpz_poly_q_struct);
    pub fn fmpz_poly_q_inv(rop: *mut fmpz_poly_q_struct, op: *mut fmpz_poly_q_struct);
    pub fn fmpz_poly_q_is_zero(op: *mut fmpz_poly_q_struct) -> c_int;
    pub fn fmpz_poly_q_is_one(op: *mut fmpz_poly_q_struct) -> c_int;
    pub fn fmpz_poly_q_equal(
        op1: *mut fmpz_poly_q_struct,
        op2: *mut fmpz_poly_q_struct,
    ) -> c_int;
    pub fn fmpz_poly_q_add_in_place(rop: *mut fmpz_poly_q_struct, op: *mut fmpz_poly_q_struct);
    pub fn fmpz_poly_q_sub_in_place(rop: *mut fmpz_poly_q_struct, op: *mut fmpz_poly_q_struct);
    ...
    pub fn fmpz_poly_q_derivative(rop: *mut fmpz_poly_q_struct, op: *mut fmpz_poly_q_struct);
    pub fn fmpz_poly_q_evaluate(
        rop: *mut __mpq_struct,
        f: *mut fmpz_poly_q_struct,
        a: *mut __mpq_struct,
    ) -> c_int;
    ...
    pub fn fmpz_poly_q_get_str(op: *mut fmpz_poly_q_struct) -> *mut c_char;
    pub fn fmpz_poly_q_get_str_pretty(
        op: *mut fmpz_poly_q_struct,
        x: *const c_char,
    ) -> *mut c_char;
    pub fn fmpz_poly_q_print(op: *mut fmpz_poly_q_struct) -> c_int;
