...
extern "C" {
    ...
    pub fn fmpz_poly_get_str(poly: *const fmpz_poly_struct) -> *mut ::std::os::raw::c_char;
    ...
    pub fn _fmpz_poly_is_one(poly: *const fmpz, len: mp_limb_signed_t) -> ::std::os::raw::c_int;
    ...
    pub fn fmpz_poly_is_squarefree(poly: *const fmpz_poly_struct) -> ::std::os::raw::c_int;
    ...
    pub fn _fmpz_poly_print(poly: *const fmpz, n: mp_limb_signed_t) -> ::std::os::raw::c_int;
