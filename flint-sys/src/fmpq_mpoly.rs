...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct fmpq_mpoly_geobucket {
    pub polys: [fmpq_mpoly_struct; 32usize],
    pub length: mp_limb_signed_t,
}

pub type fmpq_mpoly_geobucket_struct = fmpq_mpoly_geobucket;
pub type fmpq_mpoly_geobucket_t = [fmpq_mpoly_geobucket_struct; 1usize];
...
extern "C" {
    ...
    pub fn fmpq_mpoly_geobucket_init(
        B: *mut fmpq_mpoly_geobucket_struct,
        ctx: *mut fmpq_mpoly_ctx_struct,
    );
    pub fn fmpq_mpoly_geobucket_clear(
        B: *mut fmpq_mpoly_geobucket_struct,
        ctx: *mut fmpq_mpoly_ctx_struct,
    );
    pub fn fmpq_mpoly_geobucket_empty(
        p: *mut fmpq_mpoly_struct,
        B: *mut fmpq_mpoly_geobucket_struct,
        ctx: *mut fmpq_mpoly_ctx_struct,
    );
    pub fn fmpq_mpoly_geobucket_print(
        B: *mut fmpq_mpoly_geobucket_struct,
        x: *mut *const c_char,
        ctx: *mut fmpq_mpoly_ctx_struct,
    );
    pub fn fmpq_mpoly_geobucket_fit_length(
        B: *mut fmpq_mpoly_geobucket_struct,
        i: mp_limb_signed_t,
        ctx: *mut fmpq_mpoly_ctx_struct,
    );
    pub fn _fmpq_mpoly_geobucket_fix(
        B: *mut fmpq_mpoly_geobucket_struct,
        i: mp_limb_signed_t,
        ctx: *mut fmpq_mpoly_ctx_struct,
    );
    pub fn fmpq_mpoly_geobucket_set(
        B: *mut fmpq_mpoly_geobucket_struct,
        p: *mut fmpq_mpoly_struct,
        ctx: *mut fmpq_mpoly_ctx_struct,
    );
    pub fn fmpq_mpoly_geobucket_add(
        B: *mut fmpq_mpoly_geobucket_struct,
        p: *mut fmpq_mpoly_struct,
        ctx: *mut fmpq_mpoly_ctx_struct,
    );
    pub fn fmpq_mpoly_geobucket_sub(
        B: *mut fmpq_mpoly_geobucket_struct,
        p: *mut fmpq_mpoly_struct,
        ctx: *mut fmpq_mpoly_ctx_struct,
    );
    pub fn fmpq_mpoly_geobucket_set_fmpz(
        B: *mut fmpq_mpoly_geobucket_struct,
        c: *mut fmpz,
        ctx: *mut fmpq_mpoly_ctx_struct,
    );
    pub fn fmpq_mpoly_geobucket_set_fmpq(
        B: *mut fmpq_mpoly_geobucket_struct,
        c: *mut fmpq,
        ctx: *mut fmpq_mpoly_ctx_struct,
    );
    pub fn fmpq_mpoly_geobucket_gen(
        B: *mut fmpq_mpoly_geobucket_struct,
        var: mp_limb_signed_t,
        ctx: *mut fmpq_mpoly_ctx_struct,
    );
    pub fn fmpq_mpoly_geobucket_add_inplace(
        B1: *mut fmpq_mpoly_geobucket_struct,
        B2: *mut fmpq_mpoly_geobucket_struct,
        ctx: *mut fmpq_mpoly_ctx_struct,
    );
    pub fn fmpq_mpoly_geobucket_sub_inplace(
        B1: *mut fmpq_mpoly_geobucket_struct,
        B2: *mut fmpq_mpoly_geobucket_struct,
        ctx: *mut fmpq_mpoly_ctx_struct,
    );
    pub fn fmpq_mpoly_geobucket_neg_inplace(
        B1: *mut fmpq_mpoly_geobucket_struct,
        ctx: *mut fmpq_mpoly_ctx_struct,
    );
    pub fn fmpq_mpoly_geobucket_mul_inplace(
        B1: *mut fmpq_mpoly_geobucket_struct,
        B2: *mut fmpq_mpoly_geobucket_struct,
        ctx: *mut fmpq_mpoly_ctx_struct,
    );
    pub fn fmpq_mpoly_geobucket_pow_ui_inplace(
        B1: *mut fmpq_mpoly_geobucket_struct,
        k: mp_limb_t,
        ctx: *mut fmpq_mpoly_ctx_struct,
    );
    pub fn fmpq_mpoly_geobucket_pow_fmpz_inplace(
        B1: *mut fmpq_mpoly_geobucket_struct,
        k: *mut fmpz,
        ctx: *mut fmpq_mpoly_ctx_struct,
    );
    pub fn fmpq_mpoly_geobucket_divides_inplace(
        B1: *mut fmpq_mpoly_geobucket_struct,
        B2: *mut fmpq_mpoly_geobucket_struct,
        ctx: *mut fmpq_mpoly_ctx_struct,
    ) -> c_int;
