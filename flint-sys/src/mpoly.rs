...
extern "C" {
    ...
    pub fn mpoly_void_ring_elem_init(R: *mut _bindgen_ty_2) -> *mut ::std::os::raw::c_void;
    pub fn mpoly_void_ring_elem_clear(a: *mut ::std::os::raw::c_void, R: *mut _bindgen_ty_2);
