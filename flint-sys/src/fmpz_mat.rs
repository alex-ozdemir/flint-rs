...
extern "C" {
    ...
    pub fn fmpz_mat_is_zero_row(mat: *const fmpz_mat_struct, i: mp_limb_signed_t) -> libc::c_int;
    ...
    pub fn fmpz_mat_get_d_mat(B: *mut d_mat_struct, A: *const fmpz_mat_struct) -> libc::c_int;
