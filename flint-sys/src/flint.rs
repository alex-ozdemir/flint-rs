...
pub const FLINT_ERROR: flint_err_t = 0;
pub const FLINT_OVERFLOW: flint_err_t = 1;
pub const FLINT_IMPINV: flint_err_t = 2;
pub const FLINT_DOMERR: flint_err_t = 3;
pub const FLINT_DIVZERO: flint_err_t = 4;
pub const FLINT_EXPOF: flint_err_t = 5;
pub const FLINT_INEXACT: flint_err_t = 6;
pub const FLINT_TEST_FAIL: flint_err_t = 7;
...
extern "C" {
    ...
    pub fn flint_aligned_alloc(alignment: usize, size: usize) -> *mut ::std::os::raw::c_void;
