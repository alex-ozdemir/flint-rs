...
extern "C" {
    ...
    pub fn acb_is_int_2exp_si(z: *const acb_struct, e: slong) -> libc::c_int;
    ...
    pub fn acb_equal_si(x: *const acb_struct, y: slong) -> libc::c_int;
    ...
    pub fn acb_union(res: *mut acb_struct, x: *const acb_struct, y: *const acb_struct, prec: slong);
    ...
    pub fn acb_add(z: *mut acb_struct, x: *const acb_struct, y: *const acb_struct, prec: slong);
    #[link_name = "acb_sub__extern"]
    pub fn acb_sub(z: *mut acb_struct, x: *const acb_struct, y: *const acb_struct, prec: slong);
    ...
    pub fn acb_add_fmpz(z: *mut acb_struct, x: *const acb_struct, y: *const fmpz, prec: slong);
    #[link_name = "acb_add_arb__extern"]
    pub fn acb_add_arb(z: *mut acb_struct, x: *const acb_struct, y: *const arb_struct, prec: slong);
    #[link_name = "acb_sub_fmpz__extern"]
    pub fn acb_sub_fmpz(z: *mut acb_struct, x: *const acb_struct, y: *const fmpz, prec: slong);
    #[link_name = "acb_sub_arb__extern"]
    pub fn acb_sub_arb(z: *mut acb_struct, x: *const acb_struct, y: *const arb_struct, prec: slong);
    ...
    pub fn acb_mul_fmpz(z: *mut acb_struct, x: *const acb_struct, y: *const fmpz, prec: slong);
    #[link_name = "acb_mul_arb__extern"]
    pub fn acb_mul_arb(z: *mut acb_struct, x: *const acb_struct, y: *const arb_struct, prec: slong);
    ...
    pub fn acb_mul(z: *mut acb_struct, x: *const acb_struct, y: *const acb_struct, prec: slong);
    ...
    pub fn acb_addmul(z: *mut acb_struct, x: *const acb_struct, y: *const acb_struct, prec: slong);
    pub fn acb_submul(z: *mut acb_struct, x: *const acb_struct, y: *const acb_struct, prec: slong);
    #[link_name = "acb_addmul_ui__extern"]
    pub fn acb_addmul_ui(z: *mut acb_struct, x: *const acb_struct, y: ulong, prec: slong);
    #[link_name = "acb_addmul_si__extern"]
    pub fn acb_addmul_si(z: *mut acb_struct, x: *const acb_struct, y: slong, prec: slong);
    #[link_name = "acb_submul_ui__extern"]
    pub fn acb_submul_ui(z: *mut acb_struct, x: *const acb_struct, y: ulong, prec: slong);
    #[link_name = "acb_submul_si__extern"]
    pub fn acb_submul_si(z: *mut acb_struct, x: *const acb_struct, y: slong, prec: slong);
    #[link_name = "acb_addmul_fmpz__extern"]
    pub fn acb_addmul_fmpz(z: *mut acb_struct, x: *const acb_struct, y: *const fmpz, prec: slong);
    #[link_name = "acb_submul_fmpz__extern"]
    pub fn acb_submul_fmpz(z: *mut acb_struct, x: *const acb_struct, y: *const fmpz, prec: slong);
    ...
    pub fn acb_div(z: *mut acb_struct, x: *const acb_struct, y: *const acb_struct, prec: slong);
    ...
    pub fn acb_div_arb(z: *mut acb_struct, x: *const acb_struct, c: *const arb_struct, prec: slong);
    #[link_name = "acb_div_fmpz__extern"]
    pub fn acb_div_fmpz(z: *mut acb_struct, x: *const acb_struct, c: *const fmpz, prec: slong);
    pub fn acb_cube(y: *mut acb_struct, x: *const acb_struct, prec: slong);
    pub fn acb_pow_fmpz(y: *mut acb_struct, b: *const acb_struct, e: *const fmpz, prec: slong);
    ...
    pub fn acb_sin_cos(s: *mut acb_struct, c: *mut acb_struct, z: *const acb_struct, prec: slong);
    ...
    pub fn acb_sinh_cosh(y: *mut acb_struct, z: *mut acb_struct, x: *const acb_struct, prec: slong);
    ...
    pub fn acb_pow_arb(z: *mut acb_struct, x: *const acb_struct, y: *const arb_struct, prec: slong);
    pub fn acb_pow(r: *mut acb_struct, x: *const acb_struct, y: *const acb_struct, prec: slong);
    ...
    pub fn acb_sqrts(y1: *mut acb_struct, y2: *mut acb_struct, x: *const acb_struct, prec: slong);
    ...
    pub fn acb_chebyshev_t_ui(a: *mut acb_struct, n: ulong, x: *const acb_struct, prec: slong);
    ...
    pub fn acb_chebyshev_u_ui(a: *mut acb_struct, n: ulong, x: *const acb_struct, prec: slong);
    ...
    pub fn acb_rising_ui(z: *mut acb_struct, x: *const acb_struct, n: ulong, prec: slong);
    pub fn acb_rising(z: *mut acb_struct, x: *const acb_struct, n: *const acb_struct, prec: slong);
    ...
    pub fn acb_bernoulli_poly_ui(res: *mut acb_struct, n: ulong, x: *const acb_struct, prec: slong);
    ...
    pub fn acb_polylog(w: *mut acb_struct, s: *const acb_struct, z: *const acb_struct, prec: slong);
    pub fn acb_polylog_si(w: *mut acb_struct, s: slong, z: *const acb_struct, prec: slong);
    ...
    pub fn acb_agm(res: *mut acb_struct, a: *const acb_struct, b: *const acb_struct, prec: slong);
    ...
    pub fn _acb_vec_is_zero(vec: acb_srcptr, len: slong) -> libc::c_int;
    ...
    pub fn _acb_vec_add(res: acb_ptr, vec1: acb_srcptr, vec2: acb_srcptr, len: slong, prec: slong);
    pub fn _acb_vec_sub(res: acb_ptr, vec1: acb_srcptr, vec2: acb_srcptr, len: slong, prec: slong);
    ...
    pub fn _acb_vec_scalar_mul_ui(res: acb_ptr, vec: acb_srcptr, len: slong, c: ulong, prec: slong);
    pub fn _acb_vec_scalar_mul_2exp_si(res: acb_ptr, vec: acb_srcptr, len: slong, c: slong);
    pub fn _acb_vec_scalar_mul_onei(res: acb_ptr, vec: acb_srcptr, len: slong);
    pub fn _acb_vec_scalar_div_ui(res: acb_ptr, vec: acb_srcptr, len: slong, c: ulong, prec: slong);
    ...
    pub fn _acb_vec_is_real(v: acb_srcptr, len: slong) -> libc::c_int;
    pub fn _acb_vec_is_finite(vec: acb_srcptr, len: slong) -> libc::c_int;
    pub fn _acb_vec_equal(vec1: acb_srcptr, vec2: acb_srcptr, len: slong) -> libc::c_int;
    pub fn _acb_vec_overlaps(vec1: acb_srcptr, vec2: acb_srcptr, len: slong) -> libc::c_int;
    pub fn _acb_vec_contains(vec1: acb_srcptr, vec2: acb_srcptr, len: slong) -> libc::c_int;
    pub fn _acb_vec_get_real(re: arb_ptr, vec: acb_srcptr, len: slong);
    pub fn _acb_vec_get_imag(im: arb_ptr, vec: acb_srcptr, len: slong);
    pub fn _acb_vec_set_real_imag(vec: acb_ptr, re: arb_srcptr, im: arb_srcptr, len: slong);
    pub fn _acb_vec_bits(vec: acb_srcptr, len: slong) -> slong;
    pub fn _acb_vec_set_powers(xs: acb_ptr, x: *const acb_struct, len: slong, prec: slong);
    ...
    pub fn _acb_vec_get_unique_fmpz_vec(res: *mut fmpz, vec: acb_srcptr, len: slong)
        -> libc::c_int;
