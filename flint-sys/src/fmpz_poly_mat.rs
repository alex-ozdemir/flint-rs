...
extern "C" {
    ...
    pub fn fmpz_poly_mat_set(mat1: *mut fmpz_poly_mat_struct, mat2: *const fmpz_poly_mat_struct);
    ...
    pub fn fmpz_poly_mat_is_zero(mat: *const fmpz_poly_mat_struct) -> libc::c_int;
    pub fn fmpz_poly_mat_is_one(mat: *const fmpz_poly_mat_struct) -> libc::c_int;
    #[link_name = "fmpz_poly_mat_is_empty__extern"]
    pub fn fmpz_poly_mat_is_empty(mat: *const fmpz_poly_mat_struct) -> libc::c_int;
    #[link_name = "fmpz_poly_mat_is_square__extern"]
    pub fn fmpz_poly_mat_is_square(mat: *const fmpz_poly_mat_struct) -> libc::c_int;
