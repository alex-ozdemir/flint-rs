...
extern "C" {
    ...
    pub fn fmpz_poly_mat_is_zero(mat: *const fmpz_poly_mat_struct) -> ::std::os::raw::c_int;
    pub fn fmpz_poly_mat_is_one(mat: *const fmpz_poly_mat_struct) -> ::std::os::raw::c_int;
    ...
    pub fn fmpz_poly_mat_print(mat: *const fmpz_poly_mat_struct, x: *const ::std::os::raw::c_char);
