...
extern "C" {
    ...
    pub fn acb_poly_length(poly: *const acb_poly_struct) -> mp_limb_signed_t;
    #[link_name = "acb_poly_degree__extern"]
    pub fn acb_poly_degree(poly: *const acb_poly_struct) -> mp_limb_signed_t;
    pub fn acb_poly_valuation(poly: *const acb_poly_struct) -> mp_limb_signed_t;
    ...
    pub fn acb_poly_truncate(poly: *mut acb_poly_struct, newlen: mp_limb_signed_t);
    ...
    pub fn acb_poly_printd(poly: *const acb_poly_struct, digits: mp_limb_signed_t);
    ...
    pub fn acb_poly_allocated_bytes(x: *const acb_poly_struct) -> mp_limb_signed_t;
}
