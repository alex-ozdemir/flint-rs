...
use crate::deps::*;
use crate::flint::*;
use crate::mpoly::{mpoly_ctx_t, ordering_t, mpoly_ctx_struct, mpoly_zipinfo_struct, mpoly_gcd_info_struct};
...
pub struct nmod_mpolyn_struct {
    pub coeffs: *mut nmod_poly_struct,
    pub exps: *mut mp_limb_t,
    pub alloc: mp_limb_signed_t,
    pub length: mp_limb_signed_t,
...
pub struct nmod_poly_stack_struct {
    pub poly_array: *mut *mut nmod_poly_struct,
...
extern "C" {
    ...
    pub fn nmod_poly_stack_take_top_poly(S: *mut nmod_poly_stack_struct) -> *mut nmod_poly_struct;
    ...
    pub fn nmod_mpoly_from_univar_bits(
        A: *mut nmod_mpoly_struct,
        Abits: mp_limb_t,
    ...
    pub fn nmod_mpolyu_gcdm_zippel(
        ...
        B: *mut nmod_mpolyu_struct,
        ctx: *mut nmod_mpoly_ctx_struct,
        zinfo: *mut mpoly_zipinfo_struct,
    ...
    pub fn nmod_mpoly_geobucket_set_ui(
        B: *mut nmod_mpoly_geobucket_struct,
        c: mp_limb_t,
        ctx: *mut nmod_mpoly_ctx_struct,
    );
    pub fn nmod_mpoly_geobucket_gen(
        B: *mut nmod_mpoly_geobucket_struct,
        var: mp_limb_signed_t,
        ctx: *mut nmod_mpoly_ctx_struct,
    );
    pub fn nmod_mpoly_geobucket_add_inplace(
        B1: *mut nmod_mpoly_geobucket_struct,
        B2: *mut nmod_mpoly_geobucket_struct,
        ctx: *mut nmod_mpoly_ctx_struct,
    );
    pub fn nmod_mpoly_geobucket_sub_inplace(
        B1: *mut nmod_mpoly_geobucket_struct,
        B2: *mut nmod_mpoly_geobucket_struct,
        ctx: *mut nmod_mpoly_ctx_struct,
    );
    pub fn nmod_mpoly_geobucket_neg_inplace(
        B1: *mut nmod_mpoly_geobucket_struct,
        ctx: *mut nmod_mpoly_ctx_struct,
    );
    pub fn nmod_mpoly_geobucket_mul_inplace(
        B1: *mut nmod_mpoly_geobucket_struct,
        B2: *mut nmod_mpoly_geobucket_struct,
        ctx: *mut nmod_mpoly_ctx_struct,
    );
    pub fn nmod_mpoly_geobucket_pow_ui_inplace(
        B1: *mut nmod_mpoly_geobucket_struct,
        k: mp_limb_t,
        ctx: *mut nmod_mpoly_ctx_struct,
    );
    pub fn nmod_mpoly_geobucket_pow_fmpz_inplace(
        B1: *mut nmod_mpoly_geobucket_struct,
        k: *mut fmpz,
        ctx: *mut nmod_mpoly_ctx_struct,
    );
    pub fn nmod_mpoly_geobucket_divides_inplace(
        B1: *mut nmod_mpoly_geobucket_struct,
        B2: *mut nmod_mpoly_geobucket_struct,
        ctx: *mut nmod_mpoly_ctx_struct,
    ) -> c_int;
