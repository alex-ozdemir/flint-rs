...
extern "C" {
    ...
    pub fn nmod_poly_get_str(poly: *const nmod_poly_struct) -> *mut ::std::os::raw::c_char;
    ...
    pub fn nmod_poly_fprint(f: *mut FILE, poly: *const nmod_poly_struct) -> ::std::os::raw::c_int;
