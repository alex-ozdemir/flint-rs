...
extern "C" {
    ...
    pub fn fmpq_poly_is_canonical(poly: *const fmpq_poly_struct) -> ::std::os::raw::c_int;
    ...
    pub fn fmpq_poly_get_str(poly: *const fmpq_poly_struct) -> *mut ::std::os::raw::c_char;
    ...
    pub fn fmpq_poly_is_squarefree(poly: *const fmpq_poly_struct) -> ::std::os::raw::c_int;
