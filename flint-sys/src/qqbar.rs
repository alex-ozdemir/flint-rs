...
extern "C" {
    ...
    pub fn qqbar_get_str_nd(x: *const qqbar_struct, n: slong) -> *mut libc::c_char;
    ...
    pub fn qqbar_fmpq_pow_si_ui(res: *mut qqbar_struct, x: *const fmpq, a: slong, b: ulong);
    ...
    pub fn qqbar_tan_pi(res: *mut qqbar_struct, p: slong, q: ulong) -> libc::c_int;
    pub fn qqbar_cot_pi(res: *mut qqbar_struct, p: slong, q: ulong) -> libc::c_int;
    pub fn qqbar_sec_pi(res: *mut qqbar_struct, p: slong, q: ulong) -> libc::c_int;
    pub fn qqbar_csc_pi(res: *mut qqbar_struct, p: slong, q: ulong) -> libc::c_int;
    pub fn qqbar_log_pi_i(p: *mut slong, q: *mut ulong, x: *const qqbar_struct) -> libc::c_int;
    pub fn qqbar_atan_pi(p: *mut slong, q: *mut ulong, x: *const qqbar_struct) -> libc::c_int;
    pub fn qqbar_asin_pi(p: *mut slong, q: *mut ulong, x: *const qqbar_struct) -> libc::c_int;
    pub fn qqbar_acos_pi(p: *mut slong, q: *mut ulong, x: *const qqbar_struct) -> libc::c_int;
    pub fn qqbar_acot_pi(p: *mut slong, q: *mut ulong, x: *const qqbar_struct) -> libc::c_int;
    pub fn qqbar_asec_pi(p: *mut slong, q: *mut ulong, x: *const qqbar_struct) -> libc::c_int;
    pub fn qqbar_acsc_pi(p: *mut slong, q: *mut ulong, x: *const qqbar_struct) -> libc::c_int;
    pub fn qqbar_guess(
        res: *mut qqbar_struct,
        z: *const acb_struct,
        max_deg: slong,
    ...
    pub fn qqbar_enclosure_raw(res: *mut acb_struct, x: *const qqbar_struct, prec: slong);
