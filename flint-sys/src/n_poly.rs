...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct n_polyu_term_struct {
    pub exp: mp_limb_t,
    pub coeff: mp_limb_t,
}
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct n_polyun_term_struct {
    pub exp: mp_limb_t,
    pub coeff: n_poly_t,
}
...
pub struct n_polyun_struct {
    pub terms: *mut n_polyun_term_struct,
    pub length: mp_limb_signed_t,
    pub alloc: mp_limb_signed_t,
}

pub type n_polyun_t = [n_polyun_struct; 1usize];
pub type n_fq_polyun_term_struct = n_polyun_term_struct;
...
extern "C" {
    ...
    pub fn n_polyun_term_swap(A: *mut n_polyun_term_struct, B: *mut n_polyun_term_struct);
