...
extern "C" {
    ...
    pub fn arb_hypgeom_rising_ui(y: *mut arb_struct, x: *const arb_struct, n: ulong, prec: slong);
    ...
    pub fn _arb_hypgeom_erf_series(g: arb_ptr, h: arb_srcptr, hlen: slong, len: slong, prec: slong);
    ...
    pub fn _arb_hypgeom_ei_series(g: arb_ptr, h: arb_srcptr, hlen: slong, len: slong, prec: slong);
    ...
    pub fn _arb_hypgeom_si_asymp(res: *mut arb_struct, z: *const arb_struct, N: slong, prec: slong);
    ...
    pub fn _arb_hypgeom_si_series(g: arb_ptr, h: arb_srcptr, hlen: slong, len: slong, prec: slong);
    ...
    pub fn _arb_hypgeom_ci_asymp(res: *mut arb_struct, z: *const arb_struct, N: slong, prec: slong);
    ...
    pub fn _arb_hypgeom_ci_series(g: arb_ptr, h: arb_srcptr, hlen: slong, len: slong, prec: slong);
    ...
    pub fn _arb_hypgeom_shi_series(g: arb_ptr, h: arb_srcptr, hlen: slong, len: slong, prec: slong);
    ...
    pub fn _arb_hypgeom_chi_series(g: arb_ptr, h: arb_srcptr, hlen: slong, len: slong, prec: slong);
