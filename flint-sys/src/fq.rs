...
extern "C" {
    ...
    pub fn fq_embed_gens(
        ...
        minpoly: *const fmpz_mod_poly_struct,
    ...
    pub fn fq_embed_mono_to_dual_matrix(res: *mut fmpz_mod_mat_struct, ctx: *const fq_ctx_struct);
    pub fn fq_embed_dual_to_mono_matrix(res: *mut fmpz_mod_mat_struct, ctx: *const fq_ctx_struct);
}
