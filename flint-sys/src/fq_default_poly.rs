...
extern "C" {
    pub fn fq_default_poly_init(poly: *mut fq_default_poly_struct, ctx: *mut fq_default_ctx_struct);
    ...
    pub fn fq_default_poly_zero(poly: *mut fq_default_poly_struct, ctx: *mut fq_default_ctx_struct);
    pub fn fq_default_poly_one(poly: *mut fq_default_poly_struct, ctx: *mut fq_default_ctx_struct);
    pub fn fq_default_poly_gen(f: *mut fq_default_poly_struct, ctx: *mut fq_default_ctx_struct);
    ...
    pub fn fq_default_poly_xgcd(
        ...
        A: *mut fq_default_poly_struct,
        B: *mut fq_default_poly_struct,
        ctx: *mut fq_default_ctx_struct,
    );
    ...
    pub fn fq_default_poly_compose_mod(
        ...
        poly1: *mut fq_default_poly_struct,
        poly2: *mut fq_default_poly_struct,
        poly3: *mut fq_default_poly_struct,
        ctx: *mut fq_default_ctx_struct,
    );
