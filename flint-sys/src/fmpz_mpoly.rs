...
extern "C" {
    ...
    pub fn _fmpz_mpoly_fits_small(poly: *const fmpz, len: mp_limb_signed_t) -> libc::c_int;
    ...
    pub fn _fmpz_pow_ui_is_not_feasible(bbits: mp_limb_t, e: mp_limb_t) -> libc::c_int;
    pub fn _fmpz_pow_fmpz_is_not_feasible(bbits: mp_limb_t, e: *const fmpz) -> libc::c_int;
