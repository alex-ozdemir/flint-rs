...
extern "C" {
    ...
    pub fn nmod_poly_is_irreducible_rabin(f: *const nmod_poly_struct) -> ::std::os::raw::c_int;
    pub fn nmod_poly_is_irreducible_ddf(f: *const nmod_poly_struct) -> ::std::os::raw::c_int;
