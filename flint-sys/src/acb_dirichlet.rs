...
extern "C" {
    ...
    pub fn acb_dirichlet_hardy_z_zero(res: *mut arb_struct, n: *const fmpz, prec: mp_limb_signed_t);
    #[link_name = "acb_dirichlet_zeta_zero__extern"]
    pub fn acb_dirichlet_zeta_zero(res: *mut acb_struct, n: *const fmpz, prec: mp_limb_signed_t);
