...
pub type gr_funcptr = ::std::option::Option<unsafe extern "C" fn() -> ::std::os::raw::c_int>;
#[repr(C)]
...
pub type gr_method_ctx =
    ::std::option::Option<unsafe extern "C" fn(arg1: gr_ctx_ptr) -> ::std::os::raw::c_int>;
...
pub type gr_method_ctx_set_si = ::std::option::Option<
    unsafe extern "C" fn(arg1: gr_ctx_ptr, arg2: mp_limb_signed_t) -> ::std::os::raw::c_int,
>;
pub type gr_method_ctx_get_si = ::std::option::Option<
    unsafe extern "C" fn(arg1: *mut mp_limb_signed_t, arg2: gr_ctx_ptr) -> ::std::os::raw::c_int,
>;
pub type gr_method_ctx_stream = ::std::option::Option<
    unsafe extern "C" fn(arg1: *mut gr_stream_struct, arg2: gr_ctx_ptr) -> ::std::os::raw::c_int,
>;
...
pub type gr_method_unary_op = ::std::option::Option<
    unsafe extern "C" fn(arg1: gr_ptr, arg2: gr_srcptr, arg3: gr_ctx_ptr) -> ::std::os::raw::c_int,
>;
...
pub type gr_method_unary_op_ui = ::std::option::Option<
    unsafe extern "C" fn(arg1: gr_ptr, arg2: mp_limb_t, arg3: gr_ctx_ptr) -> ::std::os::raw::c_int,
>;
...
pub type gr_method_unary_op_d = ::std::option::Option<
    unsafe extern "C" fn(arg1: gr_ptr, arg2: f64, arg3: gr_ctx_ptr) -> ::std::os::raw::c_int,
>;
...
pub type gr_method_vec_ctx_op = ::std::option::Option<
    unsafe extern "C" fn(arg1: *mut gr_vec_struct, arg2: gr_ctx_ptr) -> ::std::os::raw::c_int,
>;
...
extern "C" {
    ...
    pub fn gr_stream_write_free(out: *mut gr_stream_struct, s: *mut ::std::os::raw::c_char);
    ...
    pub fn _gr_ctx_init_nmod(ctx: *mut gr_ctx_struct, nmod_t_ref: *mut ::std::os::raw::c_void);
    ...
    pub fn _gr_ctx_init_fq_from_ref(ctx: *mut gr_ctx_struct, fq_ctx: *const ::std::os::raw::c_void);
