...
extern "C" {
    pub fn _aprcl_p_ind(conf: *const _aprcl_config, p: mp_limb_t) -> ::std::os::raw::c_int;
    ...
    pub fn aprcl_is_prime_gauss_min_R(n: *const fmpz, R: mp_limb_t) -> ::std::os::raw::c_int;
    ...
    pub fn unity_zpq_equal(f: *const _unity_zpq, g: *const _unity_zpq) -> ::std::os::raw::c_int;
